    ...
    <div className="docs-shell min-h-dvh">
      <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/70">
        <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6">
          ...
          <Link
            href="/docs"
            className="inline-flex items-center gap-2 rounded-lg px-2 py-1 text-sm font-semibold text-zinc-950 hover:bg-zinc-100 dark:text-zinc-50 dark:hover:bg-zinc-900"
          >
            <span className="inline-flex h-6 w-6 items-center justify-center rounded-md bg-zinc-950 text-xs font-bold text-white dark:bg-white dark:text-zinc-950">
              K
            </span>
            Kashvi Docs
          </Link>
          ...
          <Link
            ...
            className="hidden rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-900 sm:inline-flex"
            target="_blank"
            rel="noreferrer"
          >
            GitHub
